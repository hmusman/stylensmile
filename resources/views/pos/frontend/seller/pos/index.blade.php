    ...
    <div id="order-confirm" class="modal fade">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
            <div class="modal-content" id="variants"><div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal">{{translate('Close')}}</button>
                    <button type="button" onclick="submitOrder(this,'cash')" class="btn btn-primary">{{translate('Confirm Order')}}</button>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function submitOrder(element,payment_type){
            ...
            $.post('{{ route('pos.order_place') }}',{_token:'{{ csrf_token() }}', user_id:user_id, name:name, email:email, address:address, country:country, postal_code:postal_code, phone:phone, payment_type:payment_type, shipping:shipping, discount:discount, shipping_address:shipping_address }, function(data){
                if(data == 1){
