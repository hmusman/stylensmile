                ...
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST" id="admin-products-form">
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-3">
                                <label class="aiz-checkbox">
                                    <input type="checkbox" required class="agree_checkbox" checked="">
                        ...
                        <div class="card-footer justify-content-end">
                            <button type="submit" name="owner_id" value="{{ App\User::where('user_type', 'admin')->first()->id }}" class="btn fw-600 btn-primary">{{ translate('Complete Order')}}</a>
                        </div>
                    </div>
                </form>
                @endif
                    ...
                    @if (!empty($seller_products))
                        @foreach ($seller_products as $key => $seller_product)
                            <div class="card mb-3 shadow-sm border-0 rounded">
                                ...
                                <div class="card-footer justify-content-end">
                                    <button type="submit" name="owner_id" value="{{ $key }}" class="btn fw-600 btn-primary">{{ translate('Complete Order')}}</a>
                                </div>
                            </div>
                        @endforeach
                    @endif
