<div class="aiz-category-menu bg-white rounded @if(Route::currentRouteName() == 'home') shadow-sm" @else shadow-lg" id="category-sidebar" @endif>
    ...
    <ul class="list-unstyled bg-black categories no-scrollbar py-2 mb-0 text-left newUlDes">
        @foreach (\App\Category::all()->take(11) as $key => $category)
            <li class="category-nav-element" data-id="{{ $category->id }}">
                <a href="{{ route('products.category', $category->slug) }}" class="text-truncate text-reset py-2 px-3 d-flex">
                    <img
                        ...
                        onerror="this.onerror=null;this.src='{{ static_asset('assets/img/catArr.png') }}';"
                    >
